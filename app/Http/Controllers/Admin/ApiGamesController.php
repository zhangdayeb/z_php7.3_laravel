...
{
    protected $create_field = ['title','subtitle','web_pic','web_logo','mobile_pic','api_name','class_name','game_type','params','is_open','weight','tags','remark','client_type','lang_json','logo_url','lang'];
    protected $update_field = ['title','subtitle','web_pic','web_logo','mobile_pic','api_name','class_name','game_type','params','is_open','weight','tags','remark','client_type','lang_json','logo_url','lang'];
