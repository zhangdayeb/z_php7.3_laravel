...
class ActivityController extends  MemberBaseController {
    ...
    //  app(App\Http\Controllers\Member\ActivityController::class)->getVisbleWheelSetting()
    ...
    // 获取最低的存款要求条件
    // app(App\Http\Controllers\Member\ActivityController::class)->getWheelDesc()
    ...
    // app(App\Http\Controllers\Member\ActivityController::class)->getWheelAwardPics()
