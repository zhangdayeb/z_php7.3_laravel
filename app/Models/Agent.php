...
class Agent extends Model
{
    ...
    public static $list_field = [
        ...
        'agent_pc_uri' => ['name' => '代理PC链接','type' => 'text','is_show' => false],
        'agent_wap_uri' => ['name' => '代理WAP链接','type' => 'text','is_show' => false],
        'agent_real_pc_url' => ['name' => '代理PC链接','type' => 'text','is_show' => true],
        'agent_real_wap_url' => ['name' => '代理WAP链接','type' => 'text','is_show' => true],
        'agent_uri_pre' => ['name' => '代理链接前缀','type' => 'text','is_show' => true,'validate' => 'required'],
        'apply_data' => ['name' => '申请信息','type' => 'text','is_show' => false],
