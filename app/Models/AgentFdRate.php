...
class AgentFdRate extends Model
{
    ...
    public static $list_field = [
        'parent_id' => ['name' => '父级代理ID','type' => 'number', 'is_show' => false],
        'member_id' => ['name' => '当前会员ID','type' => 'number', 'is_show' => true],
        'game_type' => ['name' => '游戏类型','type' => 'select','validate' => 'required','is_show' => true,'data' => 'platform.game_type'],
        'type' => ['name' => '点位类型','type' => 'select','validate' => 'required','is_show' => true,'data' => 'platform.agent_rate_type'],
        'rate' => ['name' => '返点比例(%)','type' => 'number','validate' => 'required','is_show' => true],
