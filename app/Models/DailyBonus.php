...
class DailyBonus extends Model
{
    ...
    public static $list_field = [
        ...
        'days' => ['name' => '签到设置天数','type' => 'text','is_show' => true],
        'serial_days' => ['name' => '连续签到天数','type' => 'text','is_show' => false],
        'total_days' => ['name' => '累计签到天数','type' => 'text','is_show' => false],
        'type' => ['name' => '类型','type' => 'select' ,'is_show' => true,'data' => 'platform.daily_bonus_type'],
        'state' => ['name' => '状态','type' => 'select', 'is_show' => false,'data' => 'platform.daily_bonus_state'],
        'lang' => ['name' => '语言/币种','type' => 'select','is_show' => true,'data' => 'platform.lang_select'],
        'remark' => ['name' => '备注','type' => 'text','is_show' => false]
    ];
