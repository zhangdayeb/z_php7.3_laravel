...
class MemberLog extends Model
{
    ...
    public static $list_field = [
        ...
        'ip' => ['name' => '操作IP','type' => 'text','is_show' => true],
        'address' => ['name' => 'IP真实地址','type' => 'text','is_show' => true],
        'ua' => ['name' => '操作环境','type' => 'text','is_show' => false],
        'type' => ['name' => '操作类型','type' => 'select','is_show' => true,'data' => 'platform.member_log_type'],
