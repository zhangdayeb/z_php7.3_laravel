...
class MemberMoneyLog extends Model
{
    ...
    public static $list_field = [
        ...
        'money' => ['name' => '操作金额', 'type' => 'number', 'validate' => 'required', 'is_show' => true],
        'money_before' => ['name' => '操作前金额', 'type' => 'number', 'is_show' => true],
        'money_after' => ['name' => '操作后金额', 'type' => 'number', 'is_show' => true],

        'money_type' => ['name' => '金额字段类型', 'type' => 'select', 'is_show' => true, 'data' => 'platform.member_money_type','style' => 'platform.member_money_type_style'],
        'number_type' => ['name' => '数量类型', 'validate' => 'required', 'type' => 'radio', 'is_show' => true, 'data' => 'platform.money_number_type','style' => 'platform.money_number_style'],
        'operate_type' => ['name' => '金额变动类型', 'type' => 'select', 'is_show' => true, 'data' => 'platform.member_money_operate_type'],

        'model_name' => ['name' => '模型名称','type' => 'text','is_show' => false],
        'model_id' => ['name' => '模型ID','type' => 'number','is_show' => false],

        'description' => ['name' => '操作描述', 'type' => 'text', 'is_show' => true],
