...
class Message extends Model
{
    ...
    public static $list_field = [
        ...
        'pid' => ['name' => '上条消息ID','type' => 'number','is_show' => false],
        'url' => ['name' => '跳转URL','type' => 'string','is_show' => false],
        'title' => ['name' => '站内信标题','type' => 'string','is_show' => true],
        'content' => ['name' => '发送内容','type' => 'string','is_show' => false],
        'visible_type' => ['name' => '可见类型','type' => 'select','is_show' => true,'data' => 'platform.message_visible_type'],
        'send_type' => ['name' => '发送类型','type' => 'select','is_show' => true,'data' => 'platform.message_send_type'],
    ...
    public static $member_field = [
        'member_id' => ['name' => '会员id', 'type' => 'number', 'is_show' => true],
        'title' => ['name' => '站内信标题','type' => 'string','is_show' => true],
        'content' => ['name' => '发送内容','type' => 'string','is_show' => true],
        'status' => ['name' => '回复状态','type' => 'select','is_show' => true,'data' => 'platform.message_status']
