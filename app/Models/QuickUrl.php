...
class QuickUrl extends Model
{
    ...
    public static $list_field = [
        'name' => ['name' => '路由标识','type' => 'text','is_show' => true],
        'title' => ['name' => '路由名称','type' => 'text','is_show' => true],
        'desc' => ['name' => '描述','type' => 'text','is_show' => true],
        'type' => ['name' => '路由类型','type' => 'select','is_show' => true,'data' => 'platform.quick_url_type'],
        'url' => ['name' => '路由地址','type' => 'text','is_show' => true],
