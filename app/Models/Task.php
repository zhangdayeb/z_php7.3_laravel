...
class Task extends Model
{
    ...
    public static $list_field = [
        'title' => ['name' => '任务标题','type' => 'text','is_show' => true],
        'condition_type' => ['name' => '任务条件','type' => 'select','is_show' => 'true','data' => 'platform.task_condition_types'],
        'condition_number' => ['name' => '每天完成任务次数','type' => 'number'],
        'condition_money' => ['name' => '完成条件金额','type' => 'number','is_show' => true],
        'condition_day' => ['name' => '累计完成任务天数','type' => 'number'],
        'award_type' => ['name' => '奖励类型','type' => 'select','data' => 'platform.task_award_type','is_show' => true],
        //'award_number' => ['name' => '奖励可领取次数','type' => 'number'],
        //'award_money' => ['name' => '奖励金额','type' => 'number'],
        'award_content' => ['name' => '奖励内容','type' => 'string'],
        //'award_per_day' => ['name' => '奖励间隔天数','type' => 'number'],
        //'award_name' => ['name' => '奖励称号','type' => 'string'],
        'remark' => ['name' => '备注信息','type' => 'string']
    ];
